        # Indirectcomparison: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/indirectcomparison.git

        ## Objective

        IndirectComparison provides tools for adjusted indirect treatment comparisons and network meta-analysis when head-to-head trials are absent, with uncertainty quantification.
        ...
        - Code: https://github.com/mahmood726-cyber/indirectcomparison.git
